...
export default function ({licenses, status, all, keyword, current_status}) {
                    ...
                    <div className="p-4 md:flex space-y-2 md:space-y-0 md:space-x-2">
                        <div>
                            <Menu>
                                <MenuButton className="border-2 font-medium px-3 h-full items-center space-x-1 text-sm rounded-lg inline-flex">
                                    ...
                                    <span className='capitalize' >{current_status ? current_status : 'Filter By Status' }</span>
                        ...
                        <div>
                            <div className="relative bg-[#F9FAFB] h-full flex items-center border-[#E5E7EB] rounded-lg border-2">
                                ...
                                <input type="text" onChange={e => router.reload({data: {keyword: e.currentTarget.value}})} defaultValue={keyword} placeholder='Search Licenses' className='pl-0 border-0 bg-transparent focus:ring-0 text-sm' />
                            </div>
                        </div>
                    </div>
